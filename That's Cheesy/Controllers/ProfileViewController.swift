...
//        label.text = "Contributions: \(added)"
        ...
        label.text = "Contributions: \(recipes.count)"
        return label
    }()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let recipes = RecipeManager().getAllRecipes()
        contributionsLabel.text = "Contributions: \(recipes.count)"
        let saves = RecipeManager().getAllSaved()
        savedLabel.text = "Saved: \(saves.count)"
    }
